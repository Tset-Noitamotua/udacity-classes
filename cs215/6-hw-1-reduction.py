...
def complenent_graph(G):
    compG = {}
    for n1 in G:
        compG[n1] = {}
        for n2 in G:
            if n2 not in G[n1]:
                compG = make_link(compG, n1, n2)
    return compG
...
def independent_set_decision(H, s):
    compG = complenent_graph(H)
    return k_clique_decision(compG, s)

print independent_set_decision({1:{}}, 1)
print independent_set_decision({1:{2:1}, 2:{1:1}}, 1)
print independent_set_decision({1:{2:1}, 2:{1:1}}, 2)
print independent_set_decision({1:{2:1, 3:1}, 2:{1:1}, 3:{1:1}, 4:{}}, 3)
print independent_set_decision({1:{2:1, 3:1}, 2:{1:1}, 3:{1:1}, 4:{}}, 4)
